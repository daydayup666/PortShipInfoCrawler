...
public class ShipInfoParser {
    ...
    // private ArrayList<String> shipInfoList = new ArrayList<>();
    ...
    public void parseUrl() {
        ...
        try {
                        ...
                        for (int j = 0; j < childNodeList.size(); j++) {
                            if (childNodeList.elementAt(j) instanceof TableRow) {
                                ...
                                for (int k = 0; k < list.size(); k++) {
                                    ...
                                    //if (rowNode.getChildren().elementAt(k) instanceof TableColumn) {
            ...
            for (PortShipInfo info : portShipInfoList) {
                System.out.println(info.getShipName() + "\t\t" + info.getDynamicInfo() + "\t\t" + info.getPortName() + "\t\t" + info.getDate());
            }
